...
const ProductItem = ({product}) => {
    return (
        <div className="col-lg-3 col-sm-6 d-flex flex-column align-items-center justify-content-center product-item mt-3">
        <div className="product"> <img src={product?.image} alt=""/>
